...
-- SHADOW B GRADE
-- id   chest  legs  head  glov  feet  skill                           shld  shsk  enchant6  mw_legs  mw_head  mw_gloves  mw_feet  mw_shield
  (143,  9067, 9068, 9069, 9071, 9072,   '3006-1;3518-1;',      0,      0,      3617,           0,       0,       0,         0,        0),--		Shadow Item: Zubei's Breastplate set
  (144,  9073, 9074, 9069, 9075, 9076,   '3006-1;3520-1;',      0,      0,      3618,           0,       0,       0,         0,        0),--		Shadow Item: Zubei's leather set
  (145,  9077, 9078, 9069, 9079, 9080,   '3006-1;3522-1;',      0,      0,      3619,           0,       0,       0,         0,        0),--		Shadow Item: Zubei robe set

-- SHADOW A GRADE
-- id   chest  legs  head  glov  feet  skill                           shld  shsk  enchant6  mw_legs  mw_head  mw_gloves  mw_feet  mw_shield
  (146,  9081, 9082, 9083, 9085, 9086,   '3006-1;3530-1;',     641,    3550,    3620,           0,       0,       0,         0,        0),--		Shadow Item: Dark Crystal Breastplate set
  (147,  9087, 9088, 9083, 9089, 9090,   '3006-1;3532-1;',      0,      0,      3621,           0,       0,       0,         0,        0),--		Shadow Item: Dark Crystal leather set
  (148,  9091,  0,   9083, 9092, 9093,   '3006-1;3535-1;',      0,      0,      3622,           0,       0,       0,         0,        0),--		Shadow Item: Dark Crystal robe set

  (149,  9094,  0,   9095, 9096, 9097,   '3006-1;3537-1;',      0,      0,      3620,           0,       0,       0,         0,        0),--		Shadow Item: Majestic plate heavy set
  (150,  9098,  0,   9095, 9099, 9100,   '3006-1;3539-1;',      0,      0,      3621,           0,       0,       0,         0,        0),--		Shadow Item: Majestic leather set
  (151,  9101,  0,   9095, 9102, 9103,   '3006-1;3541-1;',      0,      0,      3622,           0,       0,       0,         0,        0),--		Shadow Item: Majestic robe set

-- MasterWorks B GRADE
-- id   chest  legs  head  glov  feet  skill                           shld  shsk  enchant6  mw_legs  mw_head  mw_gloves  mw_feet  mw_shield
  (152, 11364,  383, 503,  5710, 5726,   '3006-1;3518-1;',      0,      0,      3617,        11355,   11363,    11356,    11359,       0),--		Masterwork Zubei's Breastplate set
  (153, 11354, 2388, 503,  5711, 5727,   '3006-1;3520-1;',      0,      0,      3618,        11353,   12978,    11357,    11360,       0),--		Masterwork Zubei's leather set
  (154, 11377, 2402, 503,  5712, 5728,   '3006-1;3522-1;',      0,      0,      3619,        11378,   12979,    11358,    11361,       0),--		Masterwork Zubei robe set

  (155, 11376, 2379, 2415, 5714, 5730,   '3006-1;3519-1;',     673,   3548,     3617,        11375,   11373,    11365,    11370,   11374),--		Masterwork Avadon heavy set
  (156, 11368, 0,    2415, 5715, 5731,   '3006-1;3521-1;',      0,      0,      3618,            0,   12980,    11366,    11371,       0),--		Masterwork Avadon leather set
  (157, 11369, 0,    2415, 5716, 5732,   '3006-1;3523-1;',      0,      0,      3619,            0,   12981,    11367,    11372,       0),--		Masterwork Avadon robe set

  (158, 11405, 2380, 2416, 5718, 5734,   '3006-1;3524-1;',      0,      0,      3617,        11395,   11403,    11399,    11396,       0),--		Masterwork Blue Wolf's Breastplate set
  (159, 11395, 0,    2416, 5719, 5735,   '3006-1;3526-1;',      0,      0,      3618,            0,   12984,    11400,    11397,       0),--		Masterwork Blue wolf leather set
  (160, 11402, 2403, 2416, 5720, 5736,   '3006-1;3528-1;',      0,      0,      3619,        11404,   12985,    11401,    11398,       0),--		Masterwork Blue Wolf robe set

  (161, 11386, 0,    2417, 5722, 5738,   '3006-1;3525-1;',     110,   3549,     3617,            0,   11387,    11379,    11382,   11385),--		Masterwork Doom plate heavy set
  (162, 11388, 0,    2417, 5723, 5739,   '3006-1;3527-1;',      0,      0,      3618,            0,   12982,    11380,    11383,       0),--		Masterwork Doom leather set
  (163, 11393, 2404, 2417, 5724, 5740,   '3006-1;3529-1;',      0,      0,      3619,        11406,   12983,    11381,    11384,       0),--		Masterwork Doom robe set

-- MasterWorks A GRADE
-- id   chest  legs  head  glov  feet  skill                           shld  shsk  enchant6  mw_legs  mw_head  mw_gloves  mw_feet  mw_shield
  (164, 11418, 388,  512,  5765, 5777,   '3006-1;3530-1;',     641,   3550,     3620,        11407,   11417,    11408,    11413,   11416),--		Masterwork Dark Crystal Breastplate set
  (165, 11411, 2389, 512,  5766, 5778,   '3006-1;3532-1;',      0,      0,      3621,        11419,   12986,    11409,    11414,       0),--		Masterwork Dark Crystal leather set
  (166, 11412, 0,    512,  5767, 5779,   '3006-1;3535-1;',      0,      0,      3622,            0,   12987,    11410,    11415,       0),--		Masterwork Dark Crystal robe set

  (167, 11445, 0,    547,  5768, 5780,   '3006-1;3531-1;',      0,      0,      3620,            0,   11446,    11437,    11441,       0),--		Masterwork Tallum plate heavy set
  (168, 11440, 0,    547,  5769, 5781,   '3006-1;3533-1;',      0,      0,      3621,            0,   12988,    11438,    11442,       0),--		Masterwork Tallum leather set
  (169, 11444, 2405, 547,  5770, 5782,   '3006-1;3534-1;',      0,      0,      3622,        11447,   12989,    11439,    11443,       0),--		Masterwork Tallum robe set

  (170, 11471, 0,    2418, 5771, 5783,   '3006-1;3536-1;',    2498,   3551,     3620,            0,   11481,    11472,    11477,   11480),--		Masterwork Nightmare heavy set
  (171, 11475, 0,    2418, 5772, 5784,   '3006-1;3538-1;',      0,      0,      3621,            0,   12992,    11473,    11478,       0),--		Masterwork Nightmare leather set
  (172, 11476, 0,    2418, 5773, 5785,   '3006-1;3540-1;',      0,      0,      3622,            0,   12993,    11474,    11479,       0),--		Masterwork Robe of nightmare set

  (173, 11457, 0,    2419, 5774, 5786,   '3006-1;3537-1;',      0,      0,      3620,            0,   11456,    11448,    11453,       0),--		Masterwork Majestic plate heavy set
  (174, 11451, 0,    2419, 5775, 5787,   '3006-1;3539-1;',      0,      0,      3621,            0,   12990,    11449,    11454,       0),--		Masterwork Majestic leather set
  (175, 11452, 0,    2419, 5776, 5788,   '3006-1;3541-1;',      0,      0,      3622,            0,   12991,    11450,    11455,       0),--		Masterwork Majestic robe set
...
-- Native Clothes
-- id   chest  legs  head  glov  feet  skill                           shld  shsk  enchant6  mw_legs  mw_head  mw_gloves  mw_feet  mw_shield
  (185,  9670, 9671, 9669,0,     0,      '3006-1;3359-1;',     0,       0,       0,              0,       0,        0,        0,       0),--		Native Clothes
