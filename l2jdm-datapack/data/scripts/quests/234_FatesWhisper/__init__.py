  ...
  def onAdvEvent (self,event,npc, player) :
    ...
    ## FINAL ITEM EXCHANGE SECTION
      ...
      for Item in st.getPlayer().getInventory().getItems():
        ...
        if TopBGradeWeaponData.has_key(weaponType) and not Item.isEquipped() and itemTemplate.getCrystalType() == 0x03 and (not itemTemplate.isCommonItem()) and itemTemplate.getCrystalCount() >= 1346 and itemTemplate.getDuration() == -1 :
