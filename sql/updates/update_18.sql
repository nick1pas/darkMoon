...
VALUES
   (88189, 'giran_blacksmith', 1, 35182, 116494, 145516, -2723, 0, 0, 58824, 60, 0, 0),
   (88186, 'giran_warehouse', 1, 35183, 115910, 145101, -2723, 0, 0, 1353, 60, 0, 0),

   (88191, 'aden_blacksmith', 1, 35272, 147908, 5595, -884, 0, 0, 48126, 60, 0, 0),
   (88192, 'aden_warehouse', 1, 35273, 147056, 5595, -884, 0, 0, 58383, 60, 0, 0),

   (88193, 'goddard_blacksmith', 1, 35361, 147037, -48781, -2639, 0, 0, 14839, 60, 0, 0),
   (88195, 'goddard_warehouse', 1, 35362, 147908, -48807, -2639, 0, 0, 20214, 60, 0, 0),

   (88196, 'oren_blacksmith', 1, 35225, 82043, 37132, -2450, 0, 0, 65001, 60, 0, 0),
   (88198, 'oren_warehouse', 1, 35224, 82464, 37592, -2450, 0, 0, 44984, 60, 0, 0),

   (88200, 'dion_blacksmith', 1, 35140, 21649, 160199, -2850, 0, 0, 61379, 60, 0, 0),
   (88199, 'dion_warehouse', 1, 35141, 22100, 159781, -2877, 0, 0, 6134, 60, 0, 0),
   
   (88202, 'gludio_blacksmith', 1, 35098, -17680, 109519, -2656, 0, 0, 29609, 60, 0, 0),
   (88201, 'gludio_warehouse', 1, 35099, -18113, 109956, -2683, 0, 0, 48351, 60, 0, 0),

   (88203, 'innadril_blacksmith', 1, 35314, 115649, 249072, -973, 0, 0, 868, 60, 0, 0),
   (88204, 'innadril_warehouse', 1, 35315, 116015, 248558, -946, 0, 0, 18052, 60, 0, 0),

   (88206, 'rune_blacksmith', 1, 35507, 12124, -49706, -1088, 0, 0, 13641, 60, 0, 0),
   (88205, 'rune_warehouse', 1, 35508, 12681, -48578, -1088, 0, 0, 39746, 60, 0, 0),

   (88208, 'schuttgart_blacksmith', 1, 35553, 77105, -152827, -907, 0, 0, 11176, 60, 0, 0),
   (88209, 'schuttgart_warehouse', 1, 35554, 77906, -152872, -934, 0, 0, 25468, 60, 0, 0);

DELETE FROM etcitem WHERE 1<>1
OR item_id=5016
OR item_id=5017
OR item_id=5018
OR item_id=5019
...
UPDATE npc SET `type` = 'L2ManorManager' WHERE `id` IN (35103,35145,35187,35229,35230,35231,35277,35319,35366,35512,35558,35644,35645);

UPDATE npc SET 
    `collision_radius` = '8.00',
	`collision_height` = '17.00',
	`level` = '70',
	`type`='L2CastleBlacksmith',
	`attackrange` = '40',
	`hp` = '3862',
	`mp` = '1493',
	`hpreg` = '11.85',
	...
	`faction_range` = '0',
	`isUndead` = '0'
  WHERE id IN (35098,35140,35182,35224,35272,35314,35361,35507,35553); 
  
  UPDATE npc SET 
    `collision_radius` = '8.00',
	`collision_height` = '17.00',
	`level` = '70',
	`type`='L2CastleWarehouse',
	`attackrange` = '40',
	`hp` = '3862',
	`mp` = '1493',
	`hpreg` = '11.85',
	...
	`faction_range` = '0',
	`isUndead` = '0'
  WHERE id IN (35099,35141,35183,35225,35273,35315,35362,35508,35554);
