...
call :execute-maven-inside l2jdm-core %COMPILE% %INSTALL% %DEPLOY% %ASSEMBLY_ASSEMBLY%
call :execute-maven-inside l2jdm-login %COMPILE% %ASSEMBLY_ASSEMBLY%
call :execute-maven-inside l2jdm-datapack %COMPILE% %ASSEMBLY_ASSEMBLY%
