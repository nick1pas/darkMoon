...
public class AdminVIPEngine implements IAdminCommandHandler
{
	...
	public void showMainPage(L2PcInstance activeChar)
	{
		...
		replyMSG
				.append("<table><tr><td><edit var=\"input1\" width=\"50\"></td><td><edit var=\"input2\" width=\"50\"></td><td><edit var=\"input3\" width\"50\"></td></tr></table>");

		replyMSG.append("<table border=\"0\"><tr>");
		replyMSG
				.append("<td width=\"100\"><button value=\"Set Team\" action=\"bypass -h admin_vip_setteam $input1\" width=90 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
		replyMSG
