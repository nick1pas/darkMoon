   ...
   if npcId == 30469 and st.getInt("cond")==0 :
      if player.getLevel() >= 24 :
        ...
        if st.getQuestItemsCount(MIRIENS_REVIEW1_ID) :
          ...
          st.addExpAndSp(int(6000*Config.RATE_QUESTS_REWARD),0)
          ...
          st.addExpAndSp(int(7000*Config.RATE_QUESTS_REWARD),0)
          ObjectId=player.getObjectId()
          player.broadcastPacket(SocialAction(ObjectId,3))
          ...
          st.addExpAndSp(int(9000*Config.RATE_QUESTS_REWARD),0)
          ObjectId=player.getObjectId()
          player.broadcastPacket(SocialAction(ObjectId,3))
          ...
          st.addExpAndSp(int(10500*Config.RATE_QUESTS_REWARD),0)
          ObjectId=player.getObjectId()
          player.broadcastPacket(SocialAction(ObjectId,3))
          ...
          st.addExpAndSp(int(12000*Config.RATE_QUESTS_REWARD),0)
          ObjectId=player.getObjectId()
          player.broadcastPacket(SocialAction(ObjectId,3))
