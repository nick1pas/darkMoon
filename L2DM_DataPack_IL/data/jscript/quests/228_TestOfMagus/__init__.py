 ...
 def onTalk (self,npc,player):
   ...
   if npcId == 30629 :
     ...
     if st.getInt("cond") and st.getQuestItemsCount(SCORE_OF_ELEMENTS)==1 and st.getQuestItemsCount(TONE_OF_WATER)==0 and st.getQuestItemsCount(UNDINE_CHARM)==0 :
        ...
        elif st.getQuestItemsCount(DAZZLING_DROP)==20 and st.getQuestItemsCount(TONE_OF_FIRE)==1 and st.getQuestItemsCount(TONE_OF_WIND)==1 and st.getQuestItemsCount(TONE_OF_EARTH)==1 :
     ...
     if st.getInt("cond") and st.getQuestItemsCount(SCORE_OF_ELEMENTS)==1 and st.getQuestItemsCount(TONE_OF_FIRE)==0 and st.getQuestItemsCount(SALAMANDER_CHARM)==0 :
        ...
        elif st.getQuestItemsCount(TONE_OF_WATER)==1 and st.getQuestItemsCount(FLAME_CRYSTAL)==5 and st.getQuestItemsCount(TONE_OF_WIND)==1 and st.getQuestItemsCount(TONE_OF_EARTH)==1 :
     ...
     if st.getInt("cond") and st.getQuestItemsCount(SCORE_OF_ELEMENTS)==1 and st.getQuestItemsCount(TONE_OF_WIND)==0 and st.getQuestItemsCount(SYLPH_CHARM)==0 :
        ...
        elif st.getQuestItemsCount(TONE_OF_WATER)==1 and st.getQuestItemsCount(TONE_OF_FIRE)==1 and st.getQuestItemsCount(HARPYS_FEATHER)+st.getQuestItemsCount(WYRMS_WINGBONE)+st.getQuestItemsCount(WINDSUS_MANE)==40 and st.getQuestItemsCount(TONE_OF_EARTH)==1 :
     ...
     if st.getInt("cond") and st.getQuestItemsCount(SCORE_OF_ELEMENTS)==1 and st.getQuestItemsCount(TONE_OF_EARTH)==0 and st.getQuestItemsCount(SERPENT_CHARM)==0 :
        ...
        elif st.getQuestItemsCount(TONE_OF_WATER)==1 and st.getQuestItemsCount(TONE_OF_FIRE)==1 and st.getQuestItemsCount(TONE_OF_WIND)==1 and st.getQuestItemsCount(EN_MONSTEREYE_SHELL)+st.getQuestItemsCount(EN_STONEGOLEM_POWDER)+st.getQuestItemsCount(EN_IRONGOLEM_SCRAP)==30 :
