...
L2-SHT Server has also a possibility to change xp/sp/drop rates relative
...
To make someone an admin you need to edit, in the L2-SHTdb database, the desired character in the 
...
Dev Team
    ...
    L2-SHT Server comes with ABSOLUTELY NO WARRANTY.
