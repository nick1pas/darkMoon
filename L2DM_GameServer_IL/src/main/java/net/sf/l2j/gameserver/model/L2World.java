...
public final class L2World implements L2WorldMBean
{
    ...
    {
    	return (x >= 0 && x <= REGIONS_X && y >= 0 && y <= REGIONS_Y);//l2world border region validity, thanks trexx 
    }
    ...
    private void initRegions()
    {
        ...
        _log.info("L2World: ("+REGIONS_X+" by "+REGIONS_Y+") World Regions Grid setted up.");
