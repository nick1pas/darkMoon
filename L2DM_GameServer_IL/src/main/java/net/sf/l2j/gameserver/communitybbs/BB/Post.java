...
public class Post
{
	private static Log _log = LogFactory.getLog(Post.class.getName());
	public class CPost
	{
	public int _PostID;
	...
	public void insertindb(CPost cp)
	{
		...
		{
			_log.warn("System: Error While Saving New Post to Database: " + e);
		}
		finally
		{
			try
	...
	{		
		...
		{
			_log.warn("System: Data Error on Post " + t.getForumID() + "/"+t.getID()+" : " + e);
			 _log.error(e.getMessage(),e);
		}
		finally
		{
