...
final class DocumentSkill extends DocumentBase {
    ...
    protected void parseSkill(Node n)
	{
        ...
        for (int i=0; i < enchantLevels1; i++)
        {
            ...
            //_currentSkill.enchsets1[i] = currentSkill.sets[currentSkill.sets.length-1];
            _currentSkill.enchsets1[i].set("level",    i+101);
            _currentSkill.enchsets1[i].set("name",     _currentSkill.name);
            //_currentSkill.enchsets1[i].set("skillType",     "NOTDONE");
        ...
        for (int i=0; i < enchantLevels2; i++)
        {
            ...
            //_currentSkill.enchsets2[i] = currentSkill.sets[currentSkill.sets.length-1];
            ...
            //_currentSkill.enchsets2[i].set("skillType",     "NOTDONE");
