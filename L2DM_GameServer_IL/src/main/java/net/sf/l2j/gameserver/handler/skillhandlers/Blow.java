...
public class Blow implements ISkillHandler
{
	...
	//L2EMU_EDIT_START
	public final static int FRONT = (Config.ALT_BLOW_FRONT);
    public final static int SIDE = (Config.ALT_BLOW_SIDE);
	public final static int BEHIND = (Config.ALT_BLOW_BEHIND);
	//L2EMU_EDIT_END
