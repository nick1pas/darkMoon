            ...
            switch(val)
            {
                ...
                case 2:
                    ...
                    replyMSG.append("The number of people on the waiting list for " +
                                    ...
                                    "<img src=\"L2UI.SquareWhite\" width=270 height=1> <img src=\"L2UI.SquareBlank\" width=1 height=3>" +
                                    //L2EMU_ADD
                                    "<button value=\"Back\" action=\"bypass -h npc_"+getObjectId()+"_OlympiadDesc 2a\" back=\"L2UI.DefaultButton_click\" fore=\"L2UI.DefaultButton\" width=67 height=19>" +
                                    "</center>");
                                    //L2EMU_ADD
                ...
                case 3:
                    ...
                    if (points >= 0)
                    {
                        ...
                        replyMSG.append("There are " + points + " Grand Olympiad " +
                                        "points granted for this event.<br>" +
                ...
                case 6:
                    ...
                    else
                    {
                        ...
                        replyMSG.append("Grand Olympiad Manager :<br>" +
                                        "Sorry, you don't have enough points for a Nobless Gate Pass." +
                                        " Better luck next time.<br>" +
                                        "<a action=\"bypass -h npc_"+getObjectId()+"_OlympiadDesc 4a\">Return</a>");
                        //L2EMU_EDIT
                        replyMSG.append("</body></html>");
                ...
                case 7:
			        //L2EMU_EDIT_ADD
                	L2Multisell.getInstance().SeparateAndSend(HardcodedMultisellist.OLYMPIAD_MANAGER, player, false, getCastle().getTaxRate());
                	break;
                case 10:
                	long l = Olympiad.getInstance().getOlympiadEnd();
                	SimpleDateFormat dateFormat = new SimpleDateFormat("dd MM HH:mm z");
                	reply = new NpcHtmlMessage(getObjectId());
                	replyMSG = new TextBuilder("<html><body>");
                	replyMSG.append("The Olympiad Period ends : " + "<font color=\"FFFF00\">"+ dateFormat.format(l)+ "</font><br>");
                	replyMSG.append("<a action=\"bypass -h npc_"+getObjectId()+"_Chat 0\">Return</a>");
                	replyMSG.append("</body></html>");
                    reply.setHtml(replyMSG.toString());
                	player.sendPacket(reply);
                	break;
        ...
        { 
            ...
            switch (val)
            {
                case 1:
                    ...
                    replyMSG.append("Grand Olympiad Games Overview<br>" +
                    ...
                    if (matches == null)
                        replyMSG.append("There are no matches at the moment");
                    else
                    {
                    ...
                    replyMSG.append("<button value=\"Back\" action=\"bypass -h npc_"+getObjectId()+"_Chat 0\" back=\"L2UI.DefaultButton_click\" fore=\"L2UI.DefaultButton\" width=67 height=19>");
                    replyMSG.append("</center>");
                    replyMSG.append("</body></html>");
                    //L2EMU_EDIT
                ...
                case 2:
                    ...
                    if (classId >= 88)
                    {
                        ...
                        replyMSG.append("<img src=\"L2UI.SquareWhite\" width=270 height=1> <img src=\"L2UI.SquareBlank\" width=1 height=3>");
                        //L2EMU_ADD
                        replyMSG.append("<button value=\"Back\" action=\"bypass -h npc_"+getObjectId()+"_OlympiadDesc 3a\" back=\"L2UI.DefaultButton_click\" fore=\"L2UI.DefaultButton\" width=67 height=19>");
                        //L2EMU_ADD
                        replyMSG.append("</center>");
                        replyMSG.append("</body></html>");
