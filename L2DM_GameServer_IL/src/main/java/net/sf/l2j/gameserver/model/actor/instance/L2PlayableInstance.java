...
public abstract class L2PlayableInstance extends L2Character 
{
    ...
    private boolean _isSalvation = false; //for Salvation skill, restores buffs after death and full CP/HP/MP  
    
    // Support for Salvation skill, where buffs are retained  
    // after resurrect and restore full CP/HP/MP  
    public final boolean isSalvation() { return _isSalvation; }  
    public final void setIsSalvation(boolean value) { _isSalvation = value; }  

    // Support for Soul of The Phoenix skill, where buffs are retained
    // after resurrect and restore full CP/HP/MP
    public final boolean isSoulOfThePhoenix() { return _isSoulOfThePhoenix; }
    public final void setIsSoulOfThePhoenix(boolean value) { _isSoulOfThePhoenix = value; }
    ...
    {
    	if (effect == null)
    		stopEffects(L2Effect.EffectType.PHOENIX_SOUL);
    	else
    		removeEffect(effect);
