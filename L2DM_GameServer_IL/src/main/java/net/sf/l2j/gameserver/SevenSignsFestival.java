...
public class SevenSignsFestival implements SpawnListener
{
     ...
     */
    //L2EMU_ADD_START
    public static final int AUTO_FIX_COUNT_FESTIVAL = 
                          (Config.ALT_FESTIVAL_CYCLE_LENGTH 
                        -  Config.ALT_FESTIVAL_LENGTH  
                        - (Config.ALT_FESTIVAL_FIRST_SPAWN 
                        + Config.ALT_FESTIVAL_FIRST_SWARM
                        - Config.ALT_FESTIVAL_FIRST_SPAWN 
                        + Config.ALT_FESTIVAL_SECOND_SPAWN - Config.ALT_FESTIVAL_FIRST_SWARM 
                        + Config.ALT_FESTIVAL_SECOND_SWARM - Config.ALT_FESTIVAL_SECOND_SPAWN 
                        + Config.ALT_FESTIVAL_CHEST_SPAWN - Config.ALT_FESTIVAL_SECOND_SWARM 
                        + Config.ALT_FESTIVAL_LENGTH - (Config.ALT_FESTIVAL_FIRST_SPAWN 
                        + Config.ALT_FESTIVAL_FIRST_SWARM - Config.ALT_FESTIVAL_FIRST_SPAWN 
                        + Config.ALT_FESTIVAL_SECOND_SPAWN - Config.ALT_FESTIVAL_FIRST_SWARM 
                        + Config.ALT_FESTIVAL_SECOND_SWARM - Config.ALT_FESTIVAL_SECOND_SPAWN 
                        + Config.ALT_FESTIVAL_CHEST_SPAWN - Config.ALT_FESTIVAL_SECOND_SWARM)))/2 ;
    
    public static final int FESTIVAL_SIGNUP_TIME = Config.ALT_FESTIVAL_CYCLE_LENGTH - Config.ALT_FESTIVAL_LENGTH - AUTO_FIX_COUNT_FESTIVAL;
    //L2EMU_ADD_END
    ...
    */
    ...
    private class FestivalManager implements Runnable
    {
        ...
        {
        	//tests 7s configs
        	if (AUTO_FIX_COUNT_FESTIVAL < 0)
        	{
        		_log.warn("SevenSignsFestival: ERROR ON CONFIG TO SEVEN SIGN , THE FESTIVAL IS STOPPED");
        		return;
        	}
        	if (Config.ALT_FESTIVAL_FIRST_SWARM - Config.ALT_FESTIVAL_FIRST_SPAWN < 0)
        	{
        		_log.warn("SevenSignsFestival: ERROR ON CONFIG ALT_FESTIVAL_FIRST_SWARM < ALT_FESTIVAL_FIRST_SPAWN , THE FESTIVAL IS STOPPED");
        		return;
        	}
        	if (Config.ALT_FESTIVAL_SECOND_SPAWN - Config.ALT_FESTIVAL_FIRST_SWARM < 0)
        	{
        		_log.warn("SevenSignsFestival: ERROR ON CONFIG ALT_FESTIVAL_SECOND_SPAWN < ALT_FESTIVAL_FIRST_SWARM , THE FESTIVAL IS STOPPED");
        		return;
        	}
        	if (Config.ALT_FESTIVAL_SECOND_SWARM - Config.ALT_FESTIVAL_SECOND_SPAWN < 0)
        	{
        		_log.warn("SevenSignsFestival: ERROR ON CONFIG ALT_FESTIVAL_SECOND_SWARM < ALT_FESTIVAL_SECOND_SPAWN , THE FESTIVAL IS STOPPED");
        		return;
        	}
        	if (Config.ALT_FESTIVAL_CHEST_SPAWN - Config.ALT_FESTIVAL_SECOND_SWARM < 0)
        	{
        		_log.warn("SevenSignsFestival: ERROR ON CONFIG ALT_FESTIVAL_CHEST_SPAWN < ALT_FESTIVAL_SECOND_SWARM , THE FESTIVAL IS STOPPED");
        		return;
        	}
