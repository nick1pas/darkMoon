...
public class AugmentationData
{
	...
	public AugmentationData()
	{
		...
		//L2EMU_EDIT_START
		_log.info("GameServer: Loaded: "+(_augmentationStats[0].size()*4)+" Augmentation Stats.");
		_log.info("GameServer: Loaded: "+_activeSkills.size()+" Active, "+_passiveSkills.size()+" Passive and "+_chanceSkills.size()+" Chance Skills");
	    //L2EMU_EDIT_END
	}
