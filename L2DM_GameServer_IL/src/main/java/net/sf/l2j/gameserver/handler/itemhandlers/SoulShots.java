...
public class SoulShots implements IItemHandler
{
	...
	private static final int[] ITEM_IDS = {
		HardcodedItemTable.SOULSHOT_NO_GRADE_FOR_NEWBIES, 
		HardcodedItemTable.SOULSHOT_NO_GRADE,
		HardcodedItemTable.SOULSHOT_GRADE_D,
		HardcodedItemTable.SOULSHOT_GRADE_C,
		HardcodedItemTable.SOULSHOT_GRADE_B,
		HardcodedItemTable.SOULSHOT_GRADE_A,
		HardcodedItemTable.SOULSHOT_GRADE_S
		};
	...
	public synchronized void useItem(L2PlayableInstance playable, L2ItemInstance item)
	{
        ...
        if ((weaponGrade == L2Item.CRYSTAL_NONE && itemId != HardcodedItemTable.SOULSHOT_NO_GRADE_FOR_NEWBIES && itemId != HardcodedItemTable.SOULSHOT_NO_GRADE) || 
			(weaponGrade == L2Item.CRYSTAL_D && itemId != HardcodedItemTable.SOULSHOT_GRADE_D) || 
			(weaponGrade == L2Item.CRYSTAL_C && itemId != HardcodedItemTable.SOULSHOT_GRADE_C) || 
			(weaponGrade == L2Item.CRYSTAL_B && itemId != HardcodedItemTable.SOULSHOT_GRADE_B) || 
			(weaponGrade == L2Item.CRYSTAL_A && itemId != HardcodedItemTable.SOULSHOT_GRADE_A) || 
			(weaponGrade == L2Item.CRYSTAL_S && itemId != HardcodedItemTable.SOULSHOT_GRADE_S))
		{
            if(!activeChar.getAutoSoulShot().containsKey(itemId)) 
