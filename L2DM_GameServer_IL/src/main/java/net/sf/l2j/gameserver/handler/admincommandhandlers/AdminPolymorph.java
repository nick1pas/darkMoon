...
public class AdminPolymorph implements IAdminCommandHandler
{
		...
		if (command.startsWith("admin_polymorph"))
		{
			...
			try
			{
				...
				if (st.hasMoreTokens())
				{
					...
					doPolymorph(admin, target, p2, p1);
				}
				else
					doPolymorph(admin, target, p1, "npc");
			}
			catch(Exception e)
			{
				admin.sendMessage("Usage: //polymoprh [type] <id>");
			}
		}
	...
	private void doPolymorph(L2PcInstance admin, L2Object obj, String id, String type)
	{
		if (obj != null)
		{
			...
			admin.sendMessage("Polymorph succeed");
		}
		else
	 ...
	 * @param target
	 */
	private void doUnpoly(L2PcInstance admin, L2Object target)
	{
		if (target !=null)
		{
			...
			admin.sendMessage("Unpolymorph succeed");
		}
		else
			admin.sendPacket(new SystemMessage(SystemMessageId.INCORRECT_TARGET));
	}
	...
	{
		//L2EMU_EDIT
		AdminHelpPage.showSubMenuPage(admin, "effects_menu.htm");
		//L2EMU_EDIT
	}
}