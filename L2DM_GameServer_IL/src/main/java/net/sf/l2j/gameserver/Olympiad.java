...
public class Olympiad
{
    ...
    //L2EMU_EDIT_START  
    private static final String OLYMPIAD_DATA_FILE = PathFindingService.OLYMPIAD_FILE;
    private static final String OLYMPIAD_DATA_FILE_SAVE = PathFindingService.OLYMPIAD_FILE_SAVE;
    public static final String OLYMPIAD_HTML_FILE =  HtmlPathService.OLYMPIAD_HTML_PATH;  
    //L2EMU_EDIT_END  
    ...
    private void load() throws IOException, SQLException
    {
        ...
        //L2EMU_EDIT_START
        InputStream is =  new FileInputStream(new File("./" + OLYMPIAD_DATA_FILE_SAVE));
        //L2EMU_EDIT_END
        ...
        try
        {
            Connection con = L2DatabaseFactory.getInstance().getConnection(null);
    ...
    public boolean registerNoble(L2PcInstance noble, boolean classBased)
    {
        ...
        {
            noble.sendMessage("Cant register when you have less than 1 point");
            return false;
        }
        //L2EMU_EDIT
        if (classBased)
    ...
    public void save() throws IOException
    {
        ...
        Properties OlympiadProperties = new Properties();
        //L2EMU_EDIT_START
        FileOutputStream fos = new FileOutputStream(new File(Config.DATAPACK_ROOT, OLYMPIAD_DATA_FILE_SAVE));
        //L2EMU_EDIT_END
        ...
        //L2EMU_EDIT_START
        OlympiadProperties.store(fos, "Save Olympiad");
        //L2EMU_EDIT_END
        fos.close();
    }
    ...
    private class L2OlympiadGame
    {
        ...
        protected boolean portPlayersToArena()
        {
            ...
            try
            {
            	if(_playerOne!=null)
            	{
            		...
            		//L2EMU_EDIT
            		//Teleport to Olympiad stadium is differend locations +-20 (thx NeoDeviL) 
                    _playerOne.teleToLocation(_stadiumPort[0]+(20 - Rnd.get(40)), _stadiumPort[1]+(20 - Rnd.get(40)), _stadiumPort[2], true);  
                    //L2EMU_EDIT
            	...
            	if(_playerTwo!=null)
            	{
            		...
            		//L2EMU_EDIT
            		//Teleport to Olympiad stadium is differend locations +-20 (thx NeoDeviL) 
            		 _playerTwo.teleToLocation(_stadiumPort[0]+(20 - Rnd.get(40)), _stadiumPort[1]+(20 - Rnd.get(40)), _stadiumPort[2], true);  
            		//L2EMU_EDIT
        ...
        protected void validateWinner()
        {
            ...
            else
            {
                ...
                int pointOneDiff;
                int pointTwoDiff;
                pointOneDiff = (playerOnePoints / 5);
                pointTwoDiff = (playerTwoPoints / 5);
