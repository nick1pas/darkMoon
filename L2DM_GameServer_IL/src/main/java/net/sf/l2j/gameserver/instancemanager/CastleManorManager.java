...
public class CastleManorManager
{
	...
	public static final CastleManorManager getInstance()
	{
		...
		{
			//L2EMU_EDIT
			_log.info("GameServer: Initializing Castle Manor Manager.");
			//L2EMU_EDIT
	...
	public long setNewManorRefresh()
	{
		...
		//L2EMU_EDIT
		_log.info("Manor System: New Schedule of Refresh @ " + _manorRefresh.getTime());
		//L2EMU_EDIT
	...
	public long setNewPeriodApprove()
	{
		...
		//L2EMU_EDIT
		_log.info("Manor System: New Schedule of Approve @ " + _periodApprove.getTime());
		//L2EMU_EDIT
