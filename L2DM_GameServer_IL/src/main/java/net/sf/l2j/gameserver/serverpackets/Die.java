...
public class Die extends L2GameServerPacket
{
	...
	//L2EMU_ADD
	private boolean _figthingInTvT;
	//L2EMU_ADD
	...
	public Die(L2Character cha)
	{
		...
		if (cha instanceof L2PcInstance)
		{
			...
			//L2EMU_ADD
			 _figthingInTvT = player.isFigthingInTvT();
			//L2EMU_ADD
		}
	...
	protected final void writeImpl()
	{
        ...
        //L2EMU_EDIT
		//if player is figthing in tvt dont sends to village button.(0x00)
		//else sends it. tested, and working.(0x01)
		//fixed spoil glow problem caused by this. correct implmentation finished now :D
		writeD(_figthingInTvT ? 0x00 : 0x01);              // 6d 00 00 00 00 - to nearest village
		//L2EMU_EDIT
