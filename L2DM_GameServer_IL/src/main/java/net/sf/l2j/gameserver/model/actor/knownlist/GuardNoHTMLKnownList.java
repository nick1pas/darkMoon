...
public class GuardNoHTMLKnownList extends AttackableKnownList
{
    ...
    public boolean addKnownObject(L2Object object, L2Character dropper)
    {
        ...
        if (object instanceof L2PcInstance) 
        {
            ...
            {
                if (Config.DEVELOPER) _log.fine(getActiveChar().getObjectId()+": PK "+player.getObjectId()+" entered scan range");
        ...
        else if ((Config.ALLOW_GUARDS) && (object instanceof L2MonsterInstance))
        {
            ...
            if (mob.isAggressive() )
            {
                if (Config.DEVELOPER) _log.fine(getActiveChar().getObjectId()+": Aggressive mob "+mob.getObjectId()+" entered scan range");
    ...
    // =========================================================
    // Property - Public
    public final L2GuardNoHTMLInstance getActiveChar() { return (L2GuardNoHTMLInstance)super.getActiveChar(); }
}