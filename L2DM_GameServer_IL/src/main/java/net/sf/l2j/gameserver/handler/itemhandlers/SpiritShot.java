...
{ 
	...
	private static final int[] ITEM_IDS = {
		HardcodedItemTable.SPIRITSHOT_NO_GRADE_FOR_NEWBIES,
		HardcodedItemTable.SPIRITSHOT_NO_GRADE,
		HardcodedItemTable.SPIRITSHOT_GRADE_D,
		HardcodedItemTable.SPIRITSHOT_GRADE_C,
		HardcodedItemTable.SPIRITSHOT_GRADE_B,
		HardcodedItemTable.SPIRITSHOT_GRADE_A,
		HardcodedItemTable.SPIRITSHOT_GRADE_S
		}; 
	...
	public synchronized void useItem(L2PlayableInstance playable, L2ItemInstance item)
	{
		...
		if ((weaponGrade == L2Item.CRYSTAL_NONE && itemId != HardcodedItemTable.SPIRITSHOT_NO_GRADE_FOR_NEWBIES && itemId != HardcodedItemTable.SPIRITSHOT_NO_GRADE) ||  
    		(weaponGrade == L2Item.CRYSTAL_D && itemId != HardcodedItemTable.SPIRITSHOT_GRADE_D) ||  
    		(weaponGrade == L2Item.CRYSTAL_C && itemId != HardcodedItemTable.SPIRITSHOT_GRADE_C) ||  
    		(weaponGrade == L2Item.CRYSTAL_B && itemId != HardcodedItemTable.SPIRITSHOT_GRADE_B) ||  
    		(weaponGrade == L2Item.CRYSTAL_A && itemId != HardcodedItemTable.SPIRITSHOT_GRADE_A) ||  
    		(weaponGrade == L2Item.CRYSTAL_S && itemId != HardcodedItemTable.SPIRITSHOT_GRADE_S)) 
		{ 
            if(!activeChar.getAutoSoulShot().containsKey(itemId)) 
