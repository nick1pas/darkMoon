...
{
    public static final int ADENA_ID = HardcodedItemTable.ADENA_ID;
    ...
    public void onBypassFeedback(L2PcInstance player, String command)
    {
        ...
        else if (command.startsWith("Crystallize")) // List player inventory items for crystallization
        {
            ...
            try
            {
                ...
                } else _pageId= Integer.parseInt(command.substring(11).trim()); 
            } 
            catch (NumberFormatException  e){_pageId=0;}
        ...
        if (command.startsWith("BreakItem")
            &&Config.ALT_CRAFT_ALLOW_CRYSTALLIZE) 
        {
        ...
        if (command.startsWith("Manufacture")) 
        {
            int _pageId;
        ...
        if (command.startsWith("CraftInfo")) 
        {
            int _recipeObjId=0;
            int _pageId=0;
            int _quantity=1;
        ...
        if (command.startsWith("CraftItem")&&
           (Config.ALT_CRAFT_ALLOW_CRAFT||Config.ALT_CRAFT_ALLOW_COMMON)) 
        {
            int _recipeObjId=0;
            int _quantity=1;
    ...
    public String getHtmlPath(int npcId, int val)
    {
        ...
        //L2EWMU_EDIT_START
        return HtmlPathService.CRAFT_MANAGER_HTML_PATH + pom + ".htm";
    //L2EMU_EDIT_END
    }
}
