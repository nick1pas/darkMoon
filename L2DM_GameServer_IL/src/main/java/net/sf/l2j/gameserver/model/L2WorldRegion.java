...
public final class L2WorldRegion
{
    ...
    private void startActivation()
    {
        ...
        _neighborsTask = ThreadPoolManager.getInstance().scheduleGeneralAtFixedRate(new NeighborsTask(true), 1000*Config.GRID_NEIGHBOR_TURN_ON_TIME, 2000);
    }
    ...
    private void startDeactivation()
    {
        ...
        _neighborsTask = ThreadPoolManager.getInstance().scheduleGeneral(new NeighborsTask(false), 1000*Config.GRID_NEIGHBOR_TURN_OFF_TIME);
    }
    ...
    public void removeVisibleObject(L2Object object)
    {
        ...
        if (object instanceof L2PlayableInstance && object != null)
        {
