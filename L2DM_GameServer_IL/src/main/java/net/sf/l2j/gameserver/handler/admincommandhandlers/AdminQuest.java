...
public class AdminQuest implements IAdminCommandHandler
{
    ...
    public boolean useAdminCommand(String command, L2PcInstance admin)
    {
        ...
        if (command.startsWith("admin_quest_reload"))
        {
        	...
        	if (parts.length < 2)
        	{
        		admin.sendMessage("Syntax: //quest_reload <questFolder> or //quest_reload <id>");
        	}
        	else
        	{
        		...
        		try
        		{
            		...
            		{
            			admin.sendMessage("Quest Reloaded Successfully.");
            		}
            		else
            		{
            			admin.sendMessage("Quest Reloaded Failed");
            		}
        		}
