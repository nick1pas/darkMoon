...
/**
 *	VoicedCommand ".autoherbs" Handler
 *	Allow player to select: use autoloot of Herbs or not
 *
 *	Syntax : .autoherbs_on/off
 *	Author : Sergey V Chursin (L2JOneo, Oneo Dev Team)
 *	WWW    : www.oneodevteam.com
...
public class AutoLootHerbs implements IVoicedCommandHandler
{
    ...
    {
		// is command enabled?
		if (!Config.ALLOW_AUTOHERBS_CMD) return false;
