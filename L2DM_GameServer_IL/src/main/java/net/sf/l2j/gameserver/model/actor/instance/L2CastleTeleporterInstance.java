...
public final class L2CastleTeleporterInstance extends L2FolkInstance
{
	...
	public String getHtmlPath(int npcId, int val)
	{
		...
		return HtmlPathService.CASTLE_TELEPORT_HTML_PATH + pom + ".htm";
	}
	...
	{
		String filename = HtmlPathService.CASTLE_TELEPORT_HTML_PATH+"castleteleporter-no.htm";
		...
		{
	        if (condition == COND_BUSY_BECAUSE_OF_SIEGE)
	            filename = HtmlPathService.CASTLE_TELEPORT_HTML_PATH+"castleteleporter-busy.htm";  // Busy because of siege
	        else if (condition == COND_OWNER)                                 // Clan owns castle
	            filename = HtmlPathService.CASTLE_TELEPORT_HTML_PATH + getNpcId() + ".htm";     // Owner message window
		}
