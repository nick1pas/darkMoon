...
public class Topic
{
	...
	private static Log _log = LogFactory.getLog(Topic.class.getName());
	...
	public void insertindb()
	{
		...
		{
			_log.warn("System: Error While Saving New Topic to Database " + e);
		}
		finally
		{
			try
	...
	{
		//TODO:TopicBBSManager.getInstance().delTopic(this);
		f.RmTopicByID(getID());
		java.sql.Connection con = null;
		try
		{
