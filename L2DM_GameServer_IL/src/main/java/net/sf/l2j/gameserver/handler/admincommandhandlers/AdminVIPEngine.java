...
public class AdminVIPEngine implements IAdminCommandHandler {
    ...
    public boolean useAdminCommand(String command, L2PcInstance admin){
        ...
        if (command.equals("admin_vip"))
            ...
            if (VIP._started == true || VIP._joining == true){
                admin.sendMessage("Cannot change variables when event has already started");
                return false;
            }
            ...
            if (params.length != 2) {
                admin.sendMessage("Wrong usage: //vip_setteam <team>");
                return false;
            }
            
            VIP.setTeam(params[1], admin);
            showMainPage(admin);
        }
            ...
            if (params.length != 2) {
                admin.sendMessage("Wrong usage: //vip_settime <time>");
                return false;
            }
            ...
            if (params.length != 2) {
                admin.sendMessage("Wrong usage: //vip_endnpc <npc>");
                return false;
            }
            
            VIP.endNPC(Integer.valueOf(params[1]), admin);
            showMainPage(admin);
        }
            ...
            if (params.length != 2) {
                admin.sendMessage("Wrong usage: //vip_joinnpc <npc>");
                return false;
            }
            
            VIP.joinNPC(Integer.valueOf(params[1]), admin);
            showMainPage(admin);
        }
            ...
            if (params.length != 2) {
                admin.sendMessage("Wrong usage: //vip_setdelay <time>");
                return false;
            }
            ...
            if (params.length != 4) {
                admin.sendMessage("Wrong usage: //vip_joinlocxyz <x> <y> <z>");
                return false;
            }
            ...
            if (params.length != 2) {
                admin.sendMessage("Wrong usage: //vip_setarea <Area>");
                return false;
            }
            ...
            if (params.length != 2) {
                admin.sendMessage("Wrong usage: //vip_vipreward <id>");
                return false;
            }
            ...
            if (params.length != 2) {
                admin.sendMessage("Wrong usage: //vip_viprewardamount <amount>");
                return false;
            }
            ...
            if (params.length != 2) {
                admin.sendMessage("Wrong usage: //vip_notvipreward <id>");
                return false;
            }
            ...
            if (params.length != 2) {
                admin.sendMessage("Wrong usage: //vip_notviprewardamount <amount>");
                return false;
            }
            ...
            if (params.length != 2) {
                admin.sendMessage("Wrong usage: //vip_thevipreward <id>");
                return false;
            }
            ...
            if (params.length != 2) {
                admin.sendMessage("Wrong usage: //vip_theviprewardamount <amount>");
                return false;
            }
    ...
    public void showMainPage(L2PcInstance admin)
    {
        ...
        replyMSG.append("    ... End NPC ID:&nbsp;<font color=\"FFFFFF\">" + VIP._endNPC + " (" + VIP.getNPCName(VIP._endNPC, admin) + ")</font><br1>");
        replyMSG.append("    ... Join NPC ID:&nbsp;<font color=\"FFFFFF\">" + VIP._joinNPC + " (" + VIP.getNPCName(VIP._joinNPC, admin) + ")</font><br>");
        ...
        replyMSG.append("    ... VIP Team Reward:&nbsp;<font color=\"FFFFFF\">" + VIP.getItemName(VIP._vipReward, admin) + " (" + VIP._vipRewardAmount + ")</font><br1>");
        replyMSG.append("    ... Not VIP Team Reward:&nbsp;<font color=\"FFFFFF\">" + VIP.getItemName(VIP._notVipReward, admin) + " (" + VIP._notVipRewardAmount + ")</font><br1>");
        replyMSG.append("    ... VIP Reward:&nbsp;<font color=\"FFFFFF\">" + VIP.getItemName(VIP._theVipReward, admin) + " (" + VIP._theVipRewardAmount + ")</font><br>");
