...
public class SkillTreeTable
{
	...
	private SkillTreeTable()
	{
        ...
        //L2EMU_EDIT_START
        _log.config("GameServer: FishingSkillTreeTable: Loaded " + count2 + " general skills.");
        _log.config("GameServer: FishingSkillTreeTable: Loaded " + count3 + " dwarven skills.");
        _log.config("GameServer: EnchantSkillTreeTable: Loaded " + count4 + " enchant skills.");
        _log.config("GameServer: PledgeSkillTreeTable: Loaded " + count5 + " pledge skills");
        //L2EMU_EDIT_END
    }
