...
public class Remedy implements IItemHandler
{
	...
	public void useItem(L2PlayableInstance playable, L2ItemInstance item)
	{
	    ...
	    if (itemId == 1831) // antidote
		{
			...
			//L2ONEO_ADD
			activeChar.sendMessage("Antidote has dissappeared.");
			//L2ONEO_ADD
		}
	    else if (itemId == 1832) // advanced antidote
		{
			...
			playable.destroyItem("Consume", item.getObjectId(), 1, null, false);
			//L2ONEO_ADD
			activeChar.sendMessage("Advanced Antidote has dissappeared.");
			//L2ONEO_ADD
		}
		else if (itemId == 1833) // bandage
		{
			...
			playable.destroyItem("Consume", item.getObjectId(), 1, null, false);
			//L2ONEO_ADD
			activeChar.sendMessage("Bandage has dissappeared.");
			//L2ONEO_ADD
		}
		else if (itemId == 1834) // emergency dressing
		{
			...
			playable.destroyItem("Consume", item.getObjectId(), 1, null, false);
			//L2ONEO_ADD
			activeChar.sendMessage("Emergency Dressing has dissappeared.");
			//L2ONEO_ADD
		}
        else if (itemId == 3889) // potion of recovery
        {
            ...
            playable.destroyItem("Consume", item.getObjectId(), 1, null, false);
          //L2ONEO_ADD
            activeChar.sendMessage("Potion of Recovery has dissappeared.");
          //L2ONEO_ADD
       }
	}
