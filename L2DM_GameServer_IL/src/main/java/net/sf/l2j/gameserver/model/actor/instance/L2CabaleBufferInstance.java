    ...
    private class CabalaAI implements Runnable
    {
        ...
        public void run()
        {
            ...
            for (L2PcInstance player : getKnownList().getKnownPlayers().values())
            {
                ...
                //L2EMU_EDIT_START
                if (playerCabal == winningCabal && playerCabal != SevenSigns.CABAL_NULL && _caster.getNpcId() == hnt.ORATOR_NPC_ID_1&& !player.isInvul()) 
                //L2EMU_EDIT_END
                {
                ...
                //L2EMU_EDIT_START
                else if (playerCabal == losingCabal && playerCabal != SevenSigns.CABAL_NULL && _caster.getNpcId() == hnt.PREACHER_NPC_ID_1&& !player.isInvul()) 
                //L2EMU_EDIT_END
                {
                    if (!player.isMageClass()) 
                    {
