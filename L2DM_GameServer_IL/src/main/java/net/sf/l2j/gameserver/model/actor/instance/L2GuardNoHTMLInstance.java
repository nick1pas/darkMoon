...
public final class L2GuardNoHTMLInstance extends L2Attackable
{
    ...
    public final GuardNoHTMLKnownList getKnownList()
    {
    	if(super.getKnownList() == null || !(super.getKnownList() instanceof GuardNoHTMLKnownList))
    		this.setKnownList(new GuardNoHTMLKnownList(this));
	...
	public void returnHome()
	{
		...
		{
			if (Config.DEVELOPER) _log.fine(getObjectId()+": moving hometo" + " X:" + _homeX + " Y:" + _homeY + " Z:" + _homeZ);
	...
	public void onAction(L2PcInstance player)
	{
		...
		if (getObjectId() != player.getTargetId())
		{
			...
			if (Config.DEVELOPER) _log.fine(player.getObjectId()+": Targetted guard "+getObjectId());
		...
		else
		{
			...
			{
				if (Config.DEVELOPER) _log.fine(player.getObjectId()+": Attacked guard "+getObjectId());
