...
public class L2ClanHallManagerInstance extends L2FolkInstance
{
    ...
    public void onBypassFeedback(L2PcInstance player, String command)
    {
        ...
        else if (condition == COND_OWNER)
        {
            ...
            if (actualCommand.equalsIgnoreCase("banish_foreigner"))
            {
                ...
                html.setFile(HtmlPathService.CH_PATH +"banish_foreigner.htm");
                sendHtmlMessage(player, html);
                //L2EMU_EDIT
            }
            //L2EMU_ADD
            else if (actualCommand.equalsIgnoreCase("expel_guest"))
            {
                getClanHall().banishForeigner(player);
                NpcHtmlMessage html = new NpcHtmlMessage(1);
                html.setFile(HtmlPathService.CH_PATH +"banish_foreigner-done.htm");
                sendHtmlMessage(player, html);
                return;
            }
            //L2EMU_ADD
            else if(actualCommand.equalsIgnoreCase("manage_vault"))
            {
                if ((player.getClanPrivileges() & L2Clan.CP_CL_VIEW_WAREHOUSE) == L2Clan.CP_CL_VIEW_WAREHOUSE)
                {
                    ...
                    else
                    {
                        NpcHtmlMessage html = new NpcHtmlMessage(1);
                        //L2EMU_EDIT
                        html.setFile(HtmlPathService.CH_PATH +"vault.htm");
                        //L2EMU_EDIT
                        sendHtmlMessage(player, html);
                    }
                }
            ...
            else if (actualCommand.equalsIgnoreCase("door"))
            {
                if ((player.getClanPrivileges() & L2Clan.CP_CH_OPEN_DOOR) == L2Clan.CP_CH_OPEN_DOOR)
                {
                    if (val.equalsIgnoreCase("open"))
                    {
                    	//L2EMU_ADD
                        NpcHtmlMessage html = new NpcHtmlMessage(1);
                        html.setFile(HtmlPathService.CH_PATH +"door_open.htm");
                        sendHtmlMessage(player, html);
                        //L2EMU_ADD
                    ...
                    else if (val.equalsIgnoreCase("close"))
                    {
                    	//L2EMU_ADD
                        NpcHtmlMessage html = new NpcHtmlMessage(1);
                        html.setFile(HtmlPathService.CH_PATH +"door_close.htm");
                        sendHtmlMessage(player, html);
                        //L2EMU_ADD
                    ...
                    else
                    {
                        NpcHtmlMessage html = new NpcHtmlMessage(1);
                        //L2EMU_EDIT
                        html.setFile(HtmlPathService.CH_PATH +"door.htm");
                        //L2EMU_EDIT
                        sendHtmlMessage(player, html);
                    }
                }
            ...
            else if (actualCommand.equalsIgnoreCase("functions"))
            {
                if (val.equalsIgnoreCase("tele"))
                {
                    ...
                    if (getClanHall().getFunction(ClanHall.FUNC_TELEPORT) == null)
                    	html.setFile(HtmlPathService.CH_PATH + "chamberlain-nac.htm");
                    else
                    	html.setFile(HtmlPathService.CH_PATH + "tele" + getClanHall().getLocation()+getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getLvl()+".htm");
                    sendHtmlMessage(player, html);
                }
                ...
                else if (val.equalsIgnoreCase("support"))
                {
                    ...
                    if (getClanHall().getFunction(ClanHall.FUNC_SUPPORT)== null)
                    	...
                    	html.setFile(HtmlPathService.CH_SUPPORT_PATH + getClanHall().getFunction(ClanHall.FUNC_SUPPORT).getLvl()+".htm");
	                ...
	                NpcHtmlMessage html = new NpcHtmlMessage(1);
	              //L2EMU_EDIT
	                html.setFile(HtmlPathService.CH_PATH +"functions.htm");
	              //L2EMU_EDIT
            ...
            else if (actualCommand.equalsIgnoreCase("manage"))
            {
                if ((player.getClanPrivileges() & L2Clan.CP_CH_SET_FUNCTIONS) == L2Clan.CP_CH_SET_FUNCTIONS)
                {
                    if (val.equalsIgnoreCase("recovery"))
                    {
                        if (st.countTokens() >= 1)
                        {
                            ...
                            {  
                                ...
                                {
                                    int fee;
                                    if (_log.isDebugEnabled()) _log.warn("Exp editing invoked");
                                    val = st.nextToken();
                                    int percent = Integer.valueOf(val);
                                    switch (percent)
                                    {
                        ...
                        NpcHtmlMessage html = new NpcHtmlMessage(1);
                        html.setFile(HtmlPathService.CH_PATH+"edit_recovery"+getClanHall().getGrade()+".htm");
                        if (getClanHall().getFunction(ClanHall.FUNC_RESTORE_HP) != null){
                    ...
                    else if (val.equalsIgnoreCase("other"))
                    {
                        if (st.countTokens() >= 1)
                        {
                            ...
                            {  
                                if (st.countTokens() >= 1)
                                {
                                	...
                                	if (_log.isDebugEnabled()) _log.warn("Item editing invoked");
                                    val = st.nextToken();
                                    int fee;
                            ...
                            {  
                                ...
                                {
                                    int fee;
                                    if (_log.isDebugEnabled()) _log.warn("Tele editing invoked");
                                    val = st.nextToken();
                                    int lvl = Integer.valueOf(val);
                                    switch (lvl)
                                    {
                            ...
                            {  
                                ...
                                {
                                    int fee;
                                    if (_log.isDebugEnabled()) _log.warn("Support editing invoked");
                                    val = st.nextToken();
                                    int lvl = Integer.valueOf(val);
                                    switch (lvl)
                                    {
                        ...
                        NpcHtmlMessage html = new NpcHtmlMessage(1);
                        html.setFile(HtmlPathService.CH_PATH+"edit_other"+getClanHall().getGrade()+".htm");
                        if (getClanHall().getFunction(ClanHall.FUNC_TELEPORT) != null){
                    ...
                    else if (val.equalsIgnoreCase("deco"))
                    {
                        if (st.countTokens() >= 1)
                        {
	                    	...
	                    	if (val.equalsIgnoreCase("curtains")){
	                            ...
	                            {
	                                int fee;
	                                if (_log.isDebugEnabled()) _log.warn("Deco curtains editing invoked");
	                                val = st.nextToken();
	                                int lvl = Integer.valueOf(val);
	                                switch (lvl)
	                                {
                        ...
                        NpcHtmlMessage html = new NpcHtmlMessage(1);
                      //L2EMU_EDIT
                        html.setFile(HtmlPathService.CH_PATH +"deco.htm");
                      //L2EMU_EDIT
                    ...
                    else
                    {
                        NpcHtmlMessage html = new NpcHtmlMessage(1);
                      //L2EMU_EDIT
                        html.setFile(HtmlPathService.CH_PATH +"manage.htm");
                      //L2EMU_EDIT
                        sendHtmlMessage(player, html);
                    }
                }
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        if(getClanHall().getFunction(ClanHall.FUNC_SUPPORT).getLvl() == 0)
                        	return;
                        //L2EMU_EDIT
                        html.setFile(HtmlPathService.CH_SUPPORT_PATH +"support-done.htm");
                        //L2EMU_EDIT
                        html.replace("%mp%", String.valueOf(getStatus().getCurrentMp()));
                        sendHtmlMessage(player, html);
                    }
    ...
    {
        player.sendPacket(new ActionFailed());
        String filename = HtmlPathService.CH_PATH + "chamberlain-no.htm";
        
        int condition = validateCondition(player);
        if (condition == COND_OWNER)
            filename = HtmlPathService.CH_PATH + "chamberlain.htm";// Owner message window 
        if (condition == COND_OWNER_FALSE)
            filename = HtmlPathService.CH_PATH + "chamberlain-of.htm";   
        NpcHtmlMessage html = new NpcHtmlMessage(1);
