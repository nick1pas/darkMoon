...
public final class L2AuctioneerInstance extends L2FolkInstance
{
        ...
        else if (condition == COND_REGULAR)
        {
            ...
            if (actualCommand.equalsIgnoreCase("auction"))
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        String filename = HtmlPathService.AUCTIONEER_HTML_PATH+"AgitSale3.htm";                        
            ...
            else if (actualCommand.equalsIgnoreCase("bidding"))
            {
                ...
                try
                {
                    ...
                    String filename = HtmlPathService.AUCTIONEER_HTML_PATH+"AgitAuctionInfo.htm";
            ...
            else if (actualCommand.equalsIgnoreCase("bid1"))
            {
                ...
                try
                {
                    String filename = HtmlPathService.AUCTIONEER_HTML_PATH+"AgitBid1.htm";
            ...
            else if (actualCommand.equalsIgnoreCase("list"))
            {
                ...
                items+= "</table>";
                String filename = HtmlPathService.AUCTIONEER_HTML_PATH+"AgitAuctionList.htm";
            ...
            else if (actualCommand.equalsIgnoreCase("bidlist"))
            {
                ...
                String filename = HtmlPathService.AUCTIONEER_HTML_PATH+"AgitBidderList.htm";
            ...
            else if (actualCommand.equalsIgnoreCase("selectedItems"))
            {
                ...
                {
                	SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy HH:mm");
                    String filename = HtmlPathService.AUCTIONEER_HTML_PATH+"AgitBidInfo.htm";
                    NpcHtmlMessage html = new NpcHtmlMessage(1);
                    html.setFile(filename);
                ...
                {
                	SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy HH:mm");
                    String filename = HtmlPathService.AUCTIONEER_HTML_PATH+"AgitSaleInfo.htm";
                    NpcHtmlMessage html = new NpcHtmlMessage(1);
                    html.setFile(filename);
                ...
                else if(player.getClan() != null && player.getClan().getHasHideout() != 0)
                {
                    ...
                    String filename = HtmlPathService.AUCTIONEER_HTML_PATH+"AgitInfo.htm";
                    NpcHtmlMessage html = new NpcHtmlMessage(1);
                    html.setFile(filename);
            ...
            else if (actualCommand.equalsIgnoreCase("cancelBid"))
            {
                ...
                String filename = HtmlPathService.AUCTIONEER_HTML_PATH+"AgitBidCancel.htm";
                NpcHtmlMessage html = new NpcHtmlMessage(1);
                html.setFile(filename);
            ...
            else if (actualCommand.equalsIgnoreCase("cancelAuction"))
            {
                ...
                String filename = HtmlPathService.AUCTIONEER_HTML_PATH+"AgitSaleCancel.htm";
                NpcHtmlMessage html = new NpcHtmlMessage(1);
                html.setFile(filename);
            ...
            {
                String filename = HtmlPathService.AUCTIONEER_HTML_PATH+"AgitSale2.htm";
                NpcHtmlMessage html = new NpcHtmlMessage(1);
                html.setFile(filename);
            ...
            else if (actualCommand.equalsIgnoreCase("sale"))
            {
                ...
                String filename = HtmlPathService.AUCTIONEER_HTML_PATH+"AgitSale1.htm";
                NpcHtmlMessage html = new NpcHtmlMessage(1);
                html.setFile(filename);
                html.replace("%AGIT_DEPOSIT%", String.valueOf(ClanHallManager.getInstance().getClanHallByOwner(player.getClan()).getLease()));
            ...
            else if (actualCommand.equalsIgnoreCase("rebid"))
            {
                ...
                try
                {
                String filename = HtmlPathService.AUCTIONEER_HTML_PATH+"AgitBid2.htm";
                NpcHtmlMessage html = new NpcHtmlMessage(1);
                html.setFile(filename);
                Auction a = AuctionManager.getInstance().getAuction(player.getClan().getAuctionBiddedAt());
                if(a != null){
            ...
            {
                NpcHtmlMessage html = new NpcHtmlMessage(1);
                html.setFile(HtmlPathService.AUCTIONEER_HTML_PATH+"location.htm");
    ...
    {
        String filename = HtmlPathService.AUCTIONEER_HTML_PATH+"auction-no.htm";

        int condition = validateCondition(player);
        if (condition == COND_BUSY_BECAUSE_OF_SIEGE) filename = HtmlPathService.AUCTIONEER_HTML_PATH+"auction-busy.htm"; // Busy because of siege
        else filename = HtmlPathService.AUCTIONEER_HTML_PATH+"auction.htm";
