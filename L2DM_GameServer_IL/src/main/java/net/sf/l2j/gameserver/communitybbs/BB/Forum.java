...
public class Forum
{
    ...
    private static Log _log = LogFactory.getLog(Forum.class.getName());
    ...
    private void load()
    {
        ...
        {
            _log.warn("System: Data Error On Forum " + _ForumId + " : " + e);
             _log.error(e.getMessage(),e);
        }
        finally
        {
    ...
    private void getChildren()
    {
        ...
        {
            _log.warn("System: Data Error on Forum Saving Children Forum to Database: " + e);
             _log.error(e.getMessage(),e);
        }
        finally
        {
    ...
    public void insertindb()
    {
        ...
        {
            _log.warn("System: Error While Saving New Forum To Database:" + e);
        }
        finally
        {
            try
