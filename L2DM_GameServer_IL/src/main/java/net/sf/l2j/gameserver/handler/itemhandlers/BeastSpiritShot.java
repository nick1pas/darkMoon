...
public class BeastSpiritShot implements IItemHandler
{
    ...
    private static final int[] ITEM_IDS = {HardcodedItemTable.BEAST_SPIRITSHOT, HardcodedItemTable.BLESSED_BEAST_SPIRITSHOT};
    ...
    public void useItem(L2PlayableInstance playable, L2ItemInstance item)
    {
        ...
        boolean isBlessed = (itemId == HardcodedItemTable.BLESSED_BEAST_SPIRITSHOT);
