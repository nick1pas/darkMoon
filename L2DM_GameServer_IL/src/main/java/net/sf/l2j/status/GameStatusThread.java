...
public class GameStatusThread extends Thread
{
    ...
    public GameStatusThread(Socket client, int uptime, String StatusPW) throws IOException
    {
        ...
        if ( isValidIP(client) ) {    
            ...
            //L2EMU_EDIT_START
            _print.println("Welcome To The L2Emu Project Telnet Session.");
            //L2EMU_EDIT_END
            ...
            else 
            {
                ...
                else
                {
                    ...
                    _print.println("[L2Emu Project] Telnet Console");
                    _print.print("");
                    _print.flush();
                    start();
                }
                ...
                else if(_usrCommand.startsWith("admin_reload_config"))
                {
                    ...
                    try
                    {
                        ...
                        else if(type.equals("bosses"))
                        {
                            ...
                            Config.loadBaiumConfig();
                            //L2EMU_ADD_START
                            if (Config.ENABLEVANHALTERMANAGER)
                            	Config.loadVanHalterConfig();
                            // L2EMU_ADD_END
                            _print.println("Bosses configs reloaded");
                        }
